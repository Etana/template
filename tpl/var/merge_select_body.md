...
## Chemin
[`Index`](http://votre-forum.appspot.com/#/admin/,&part=themes,&mode=moderation&sub=templates,?mode=edit_moderation&part=themes&sub=templates&t=602) > [`Panneau d'administration`](http://votre-forum.appspot.com/admin/#&part=themes,&mode=moderation&sub=templates,?mode=edit_moderation&part=themes&sub=templates&t=602) > [`Affichage`](http://votre-forum.appspot.com/admin/?part=themes#&mode=moderation&sub=templates,?mode=edit_moderation&part=themes&sub=templates&t=602) > [`Templates | Modération`](http://votre-forum.appspot.com/admin/?mode=moderation&part=themes&sub=templates#?mode=edit_moderation&part=themes&sub=templates&t=602) > [`merge_select_body`](http://votre-forum.appspot.com/admin/?mode=edit_moderation&part=themes&sub=templates&t=602)

## Code source
* [__phpBB2__](../src/subsilver/merge_select_body.tpl#files)
* [__PunBB__](../src/punbb/merge_select_body.tpl#files)
...
* __[`{LOGGED_AS}`](https://github.com/Etana/template/blob/master/var/LOGGED_AS.md#readme) :__ ligne [`7`](../src/punbb/merge_select_body.tpl#L7)
* __[`{L_GO}`](https://github.com/Etana/template/blob/master/var/L_GO.md#readme) :__ ligne [`20`](../src/punbb/merge_select_body.tpl#L20)
* __[`{L_LOGIN_REGISTER}`](https://github.com/Etana/template/blob/master/var/L_LOGIN_REGISTER.md#readme) :__ ligne [`12`](../src/punbb/merge_select_body.tpl#L12)
* __[`{L_NOT_CONNECTED}`](https://github.com/Etana/template/blob/master/var/L_NOT_CONNECTED.md#readme) :__ ligne [`12`](../src/punbb/merge_select_body.tpl#L12)
...
* __[`{MERGE_BOX}`](https://github.com/Etana/template/blob/master/var/MERGE_BOX.md#readme) :__ ligne [`23`](../src/punbb/merge_select_body.tpl#L23)
...
* __[`{S_LIST_FORUMS}`](https://github.com/Etana/template/blob/master/var/S_LIST_FORUMS.md#readme) :__ ligne [`20`](../src/punbb/merge_select_body.tpl#L20)
...
* __[`{MERGE_BOX}`](https://github.com/Etana/template/blob/master/var/MERGE_BOX.md#readme) :__ ligne [`9`](../src/subsilver/merge_select_body.tpl#L9)
...
* __[`{S_LIST_FORUMS}`](https://github.com/Etana/template/blob/master/var/S_LIST_FORUMS.md#readme) :__ ligne [`5`](../src/subsilver/merge_select_body.tpl#L5)
