...
* __[`{L_SEARCH_EXPLAIN}`](https://github.com/Etana/template/blob/master/var/L_SEARCH_EXPLAIN.md#readme) :__ ligne [`16`](../src/punbb/search_username.tpl#L16)
* __[`{L_SEARCH_USERNAME}`](https://github.com/Etana/template/blob/master/var/L_SEARCH_USERNAME.md#readme) :__ ligne [`9`](../src/punbb/search_username.tpl#L9)
* __[`{L_SELECT}`](https://github.com/Etana/template/blob/master/var/L_SELECT.md#readme) :__ ligne [`23`](../src/punbb/search_username.tpl#L23)
...
* __[`{S_USERNAME_OPTIONS}`](https://github.com/Etana/template/blob/master/var/S_USERNAME_OPTIONS.md#readme) :__ ligne [`21`](../src/punbb/search_username.tpl#L21)
* __[`{USERNAME}`](https://github.com/Etana/template/blob/master/var/USERNAME.md#readme) :__ ligne [`15`](../src/punbb/search_username.tpl#L15)
* __[`<!-- BEGIN html_validation -->`](https://github.com/Etana/template/blob/master/var/html_validation.md#readme) :__ ligne [`1`](../src/punbb/search_username.tpl#L1)
...
* __[`<!-- BEGIN switch_select_name -->`](https://github.com/Etana/template/blob/master/var/switch_select_name.md#readme) :__ ligne [`18`](../src/punbb/search_username.tpl#L18)
...
* __[`{L_SEARCH_EXPLAIN}`](https://github.com/Etana/template/blob/master/var/L_SEARCH_EXPLAIN.md#readme) :__ ligne [`13`](../src/subsilver/search_username.tpl#L13)
* __[`{L_SEARCH_USERNAME}`](https://github.com/Etana/template/blob/master/var/L_SEARCH_USERNAME.md#readme) :__ ligne [`7`](../src/subsilver/search_username.tpl#L7)
...
* __[`{S_USERNAME_OPTIONS}`](https://github.com/Etana/template/blob/master/var/S_USERNAME_OPTIONS.md#readme) :__ ligne [`17`](../src/subsilver/search_username.tpl#L17)
* __[`{USERNAME}`](https://github.com/Etana/template/blob/master/var/USERNAME.md#readme) :__ ligne [`12`](../src/subsilver/search_username.tpl#L12)
* __[`<!-- BEGIN switch_select_name -->`](https://github.com/Etana/template/blob/master/var/switch_select_name.md#readme) :__ ligne [`14`](../src/subsilver/search_username.tpl#L14)
