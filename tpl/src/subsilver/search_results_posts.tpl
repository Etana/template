...
<!-- BEGIN searchresults -->
<tr>
<td class="catHead" colspan="2" height="28"><span class="topictitle"><img src="{searchresults.TOPIC_FOLDER_IMG}" align="top" /> {L_TOPIC}:&nbsp;<a class="topictitle" href="{searchresults.U_TOPIC}">{searchresults.TOPIC_TITLE}</a></span></td>
</tr>
<tr>
<td class="row1" rowspan="2" valign="top" width="150"><span class="name"><b>{searchresults.POSTER_NAME}</b></span><br />
<br />
<span class="postdetails">{L_REPLIES}: <b>{searchresults.TOPIC_REPLIES}</b><br />{L_VIEWS}: <b>{searchresults.TOPIC_VIEWS}</b></span><br />
</td>
<td class="row1" valign="top" width="100%"><span class="postdetails">{L_FORUM}:&nbsp;<b><a class="postdetails" href="{searchresults.U_FORUM}">{searchresults.FORUM_NAME}</a></b> &nbsp; &nbsp;<img title="{searchresults.L_MINI_POST_ALT}" src="{searchresults.MINI_POST_IMG}" alt="" border="0">{L_SUBJECT}: <b><a href="{searchresults.U_POST}">{searchresults.POST_SUBJECT}</a></b> &nbsp; &nbsp;<img src="{ICON_TIME}" alt="" border="0">{searchresults.POST_DATE}</span></td>
</tr>
<tr>
