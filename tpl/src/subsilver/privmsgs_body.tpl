...
<td width="100%"></td>
<td align="right" nowrap="nowrap"><span class="gensmall">{L_DISPLAY_MESSAGES}:&nbsp;<select name="msgdays">
{S_SELECT_MSG_DAYS}
</select>&nbsp;<input class="liteoption" type="submit" name="submit_msgdays" value="{L_GO}"></span></td>
</tr>
</table>
...
<td class="{listrow.ROW_CLASS}" valign="middle" width="55%">&nbsp;<span class="topictitle">&nbsp;<a class="topictitle" href="{listrow.U_READ}">{listrow.SUBJECT}</a></span></td>
...
<td class="{listrow.ROW_CLASS}" align="center" valign="middle" width="5%"><span class="postdetails"><input type="checkbox" name="mark[]2" value="{listrow.S_MARK_ID}"></span></td>
</tr>
...
<td align="right" valign="top" nowrap="nowrap"><b><span class="gensmall"><a class="gensmall" href="javascript:select_switch_privmsg(true);">{L_MARK_ALL}</a> :: <a class="gensmall" href="javascript:select_switch_privmsg(false);">{L_UNMARK_ALL}</a></span></b><br /><br />
