		...
		<td class="catbottom" colspan="8" align="right" height="28">
			<table width="100%" align="center" cellspacing="0" cellpadding="0">
				...
				<td align="right">
					...
					<input type="submit" class="liteoption" name="lock" value="{L_LOCK}" />&nbsp;&nbsp;<input type="submit" class="liteoption" name="unlock" value="{L_UNLOCK}" />&nbsp;&nbsp;{APPROVAL_BUTTON}&nbsp;&nbsp;{UNAPPROVAL_BUTTON}&nbsp;&nbsp;{DELETE_BUTTON}
				</td></tr>
			</table>
		</td>
	</tr>
...
<table width="100%" align="center" cellspacing="1" cellpadding="0" border="0">
	...
	<td valign="top"><span class="nav">{PAGE_NUMBER}</span></td>
		...
		<b><span class="gensmall"><a href="#" class="gensmall" onclick="this.value=check('select','modcp');return false;">{L_CHECK_ALL}</a> :: <a href="#" class="gensmall" onclick="this.value=check('unselect','modcp');return false;">{L_UNCHECK_ALL}</a></b></span>
