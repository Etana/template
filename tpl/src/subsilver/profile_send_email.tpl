...
<td class="row2" width="78%"><span class="gen"><input class="post" style="width:450px" type="text" name="subject" value="{SUBJECT}" size="45" maxlength="100" tabindex="2"></span></td>
</tr>
<tr>
<td class="row1" valign="top"><span class="gen"><b>{L_MESSAGE_BODY}</b></span><br />
<span class="gensmall">{L_MESSAGE_BODY_DESC}</span></td>
<td class="row2"><span class="gen"><textarea class="post" style="width:500px" name="message" rows="25" cols="40" tabindex="3" wrap="virtual">{MESSAGE}</textarea></span>
<!-- BEGIN switch_tell_friend -->
<br /><span class="gen"><input type="text" class="post" size="81" value="{MAIL_LINK}" disabled></span>
<!-- END switch_tell_friend -->
</td>
</tr>
<tr>
