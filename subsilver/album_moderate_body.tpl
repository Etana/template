	...
	<tr>
		<td class="nav">
			<span class="nav">
				...
				<a class="nav" href="{U_ALBUM}">{L_ALBUM}</a>{NAV_CAT_DESC}
			</span>
		</td>
	</tr>
</table>
...
<table class="forumline" width="100%" align="center" cellspacing="1" cellpadding="0">
	<tr><td class="catHead" height="25" align="center" colspan="8"><span class="cattitle">{L_MODCP}&nbsp;</span></td>	</tr>
	<tr>
	...
	<tr>
		<td class="row2" height="25">
			<span class="genmed"><a href="{picrow.PIC_LINK}" target="_blank" onMouseOver="createTitle(this, '{picrow.PIC_MESSAGE}', event.pageX, event.pageY);" onMouseOut="destroyTitle();">{picrow.PIC_TITLE}</a></span>
		</td>
		<td align="center" class="row1">
			<span class="genmed">{picrow.POSTER}</span>
		</td>
		<td align="center" class="row2">
			<span class="genmed">{picrow.TIME}</span>
		</td>
	...
	<tr>
		<td class="catbottom" colspan="8" align="right" height="28">
			...
			<input type="submit" class="liteoption" name="lock" value="{L_LOCK}" />&nbsp;&nbsp;<input type="submit" class="liteoption" name="unlock" value="{L_UNLOCK}" />&nbsp;&nbsp;<input type="submit" class="liteoption" name="approval" value="{L_APPROVE}" />&nbsp;&nbsp;<input type="submit" class="liteoption" name="unapproval" value="{L_UNAPPROVAL}" />&nbsp;&nbsp;<input type="submit" class="liteoption" name="delete" value="{L_DELETE}" />
		</td>
	</tr>
	<tr>
...
<table width="100%" align="center" cellspacing="1" cellpadding="0" border="0">
	...
	<td valign="top"><span class="nav">{PAGE_NUMBER}</span></td>
		...
		<b><span class="gensmall"><a href="cellpadding="0"" class="gensmall" onclick="this.value=checkmodcp('select');return false;">{L_CHECK_ALL}</a> :: <a href="cellpadding="0"" class="gensmall" onclick="this.value=checkmodcp('unselect');return false;">{L_UNCHECK_ALL}</a></b></span>
			<span class="nav">{PAGINATION}&nbsp;</span><span class="gensmall">{S_TIMEZONE}&nbsp;</span>
		</td>
		</form>
	</tr>
</table>
