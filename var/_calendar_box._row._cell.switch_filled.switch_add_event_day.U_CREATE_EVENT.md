...
* __Disponible dans :__ une boucle [`<!-- BEGIN switch_add_event_day -->...<!-- END switch_add_event_day -->`](https://github.com/Etana/template/blob/master/var/_calendar_box._row._cell.switch_filled.switch_add_event_day.md#readme)
* __Utilisation :__
...
### Version phpBB2
* __[`calendar_box`](../tpl/var/calendar_box.md#readme) :__ ligne [`44`](../tpl/src/subsilver/calendar_box.tpl#L44)