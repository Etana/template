...
* __Disponible dans :__ une boucle [`<!-- BEGIN switch_no_comment -->...<!-- END switch_no_comment -->`](https://github.com/Etana/template/blob/master/var/post_row.switch_attachments.switch_post_attachments.switch_no_comment.md#readme)
* __Utilisation :__
