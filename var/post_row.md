...
## Attributs
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.CLOSE}`](../var/post_row.CLOSE.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.CLOSE))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.ID}`](../var/post_row.ID.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.ID))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.L_READ_FULL}`](../var/post_row.L_READ_FULL.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.L_READ_FULL))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.OPEN}`](../var/post_row.OPEN.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.OPEN))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.POSTER}`](../var/post_row.POSTER.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.POSTER))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.REPLIES}`](../var/post_row.REPLIES.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.REPLIES))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`<!-- BEGIN saut -->`](../var/post_row.saut.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.saut))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`<!-- BEGIN switch_attachments -->`](../var/post_row.switch_attachments.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.switch_attachments))__
* __&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.switch_attachments.L_ATTACHMENTS}`](../var/post_row.switch_attachments.L_ATTACHMENTS.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.switch_attachments.L_ATTACHMENTS))__
* __&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[`<!-- BEGIN switch_post_attachments -->`](../var/post_row.switch_attachments.switch_post_attachments.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.switch_attachments.switch_post_attachments))__
...
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.U_READ_FULL}`](../var/post_row.U_READ_FULL.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.U_READ_FULL))__
* __&nbsp;&nbsp;&nbsp;&nbsp;[`{post_row.U_VIEW_COMMENTS}`](../var/post_row.U_VIEW_COMMENTS.md#readme) ([x](https://fa-tvars.appspot.com/var/post_row.U_VIEW_COMMENTS))__
...
* __[`viewcomments_body`](../tpl/viewcomments_body.md#readme) :__ lignes [`319`](../src/subsilver/viewcomments_body.tpl#L319)[`<->`](../src/subsilver/viewcomments_body.tpl#L319-L350)[`350`](../src/subsilver/viewcomments_body.tpl#L350)
