...
* __Disponible dans :__ [`album_modcp_body`](../tpl/var/album_modcp_body.md), [`album_moderate_body`](../tpl/var/album_moderate_body.md), [`album_search_body`](../tpl/var/album_search_body.md), [`birthday_list_box`](../tpl/var/birthday_list_box.md), [`calendar_scheduler_body`](../tpl/var/calendar_scheduler_body.md), [`groupcp_info_body`](../tpl/var/groupcp_info_body.md), [`memberlist_body`](../tpl/var/memberlist_body.md), [`merge_select_body`](../tpl/var/merge_select_body.md), [`modcp_body`](../tpl/var/modcp_body.md), [`privmsgs_body`](../tpl/var/privmsgs_body.md), [`report_list_body`](../tpl/var/report_list_body.md), [`search_results_posts`](../tpl/var/search_results_posts.md), [`search_results_topics`](../tpl/var/search_results_topics.md), [`topics_list_box`](../tpl/var/topics_list_box.md), [`viewforum_body`](../tpl/var/viewforum_body.md), [`viewtopic_body`](../tpl/var/viewtopic_body.md)
* __Utilisation :__
