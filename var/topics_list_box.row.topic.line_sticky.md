...
<!-- BEGIN topics_list_box -->
    <!-- BEGIN row -->
        <!-- BEGIN topic -->
        <!-- BEGIN topics_list_box.row.topic.line_sticky -->
        contenu
        <!-- END topics_list_box.row.topic.line_sticky -->
        <!-- END topic -->
    <!-- END row -->
<!-- END topics_list_box -->
```
...
##Description
[*ajouter*](https://fa-tvars.appspot.com/var/topics_list_box.row.topic.line_sticky)
