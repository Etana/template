...
* __Exemple de remplacement français :__ `Nos membres ont posté un total de <strong>2</strong> messages`
* __Exemple de code pour ne conserver que le chiffre :__ ```<span id=tp>{TOTAL_POSTS}</span>
