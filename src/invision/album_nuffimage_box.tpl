...
<div class="row2"><h3>{L_NUFF_TITLE}</h3></div>
...
<form name="nuffimage_form" action="" method="post">
	<fieldset class="effects">
		...
		<dl>
			...
			<dd class="clearfix"><img src="{IMG_MIRROR}" alt="" class="effect" /></dd>
		</dl>
		...
		<dl>
			...
			<dd class="clearfix"><img src="{IMG_SCREEN}" alt="" class="effect" /></dd>
		</dl>
		<dl>
			...
			<dd class="clearfix"><img src="{IMG_INTERLACE}" alt="" class="effect" /></dd>
		</dl>
		...
		<dl>
			...
			<dd class="clearfix"><img src="{IMG_PIXELATE}" alt="" class="effect" /></dd>
		</dl>
		<dl>
		...
		<dl>
			...
			<dd class="clearfix"><img src="{IMG_INFRARED}" alt="" class="effect" /></dd>
		</dl>
		<!-- END sepia_bw_enabled -->
		<dl>
