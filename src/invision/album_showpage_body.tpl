...
<div class="borderwrap view-photo">
	<a name="TopPic"></a>
	<div class="maintitle clearfix">
		...
		<h3>{PREV_PIC}&nbsp;&nbsp;<strong>{PIC_TITLE}</strong>&nbsp;&nbsp;{NEXT_PIC}</h3>
	</div>
	<div class="box-content">

		<form name="action" method="get" action="{U_SHOWPAGE_ACTION}" class="ipbform2">
			<fieldset>
				<p class="center">
					{SID}
...
<!-- BEGIN display_infos -->
<div class="subtitle"><h3>{L_INFOS}</h3></div>
...
<br />
<!-- BEGIN pics_nav -->
<div class="borderwrap photostrip">
	<div class="maintitle clearfix">
		<p class="left">{FIRST_PIC}</p>
		<p class="right">{LAST_PIC}</p>
		<h3>{PREV_PIC} {pics_nav.L_PICS_NAV} {NEXT_PIC}</h3>
	</div>
	<div class="box-content clearfix">
		<!-- BEGIN noprev -->
		<div class="row1 photo" style="width: 18.5%; height: 100px; text-align: center;">
		</div>
		<!-- END noprev -->
		<!-- BEGIN prev -->
		<div class="row1 photo" style="width: 18.5%; height: 100px; text-align: center;">
		...
		<!-- END prev -->
		<div class="row1 photo" style="width: 18.5%; height: 100px; text-align: center; background-color: #F6F4D0;">
