...
<div id="ipbwrapper">
	<div class="borderwrap">
		<div class="maintitle center">
			<h3 id="PicHeader">{PIC_TITLE}</h3>
		</div>

		<div class="box-content">
			<form name="slideshow" action="{U_SLIDESHOW}" method="post" onsubmit="return true;" class="ipbform">
				<br />
				<div class="center">
					{SLIDESHOW_SELECT}
					<input type="submit" class="button" value="{L_SLIDESHOW_ONOFF}" /><br /><br />
