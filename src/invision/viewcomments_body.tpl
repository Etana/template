...
<div class="borderwrap">
	...
	<!-- BEGIN postrow -->
	<!-- BEGIN hidden -->
	<div class="topic-footer" align="center">
...
<span class="blog_cal-{postrow.displayed.POST_DATE_DMY_CLASS2}">{postrow.displayed.POST_DATE_DMY_VALUE2}</span>
				...
				<h3>{postrow.displayed.ICON} <a href="{postrow.displayed.POST_URL}" name="{postrow.displayed.U_POST_ID}">{postrow.displayed.POST_SUBJECT}</a></h3>
...
<div class="borderwrap" id="blog_comments">
	...
	<!-- END hidden -->
	<!-- BEGIN displayed -->
	<div id="p{comment.displayed.U_POST_ID}" class="post {comment.displayed.ONLINE_IMG_NEW} clearfix post--{comment.displayed.U_POST_ID}"{comment.displayed.THANK_BGCOLOR} style="{comment.displayed.DISPLAYABLE_STATE}">

		<div class="postbody-head postdetails post-header"{comment.displayed.THANK_BGCOLOR}>
			<ul class="post-info">
		...
		<div class="post-footer clearfix"{comment.displayed.THANK_BGCOLOR}>
			<ul class="misc-icons">
				<li><a href="#top">{L_BACK_TO_TOP}</a></li>
...
<script type="text/javascript">
//<![CDATA[
$(resize_images({ 'selector' : '.post-entry', 'max_width' : {switch_image_resize.IMG_RESIZE_WIDTH}, 'max_height' : {switch_image_resize.IMG_RESIZE_HEIGHT} }));
//]]>
</script>
