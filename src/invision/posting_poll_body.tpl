	<h3 class="subtitle">{L_ADD_A_POLL}</h3>
		<div id="poll_off" style="display:none;">
			<fieldset>
			<dl>
				<dt></dt>
				<dd><a href="javascript:void(0);" onclick="togglePoll('on');">{L_OPEN_POLL_FORM}</a></dd>
			</dl>
			</fieldset>
		</div>
		<div id="poll_on">
			...
			<dl>
				<dt>&nbsp;</dt>
				<dd><a href="javascript:void(0);" onclick="togglePoll('off');">{L_CLOSE_POLL_FORM}</a></dd>
			</dl>
			</fieldset>
		</div>
