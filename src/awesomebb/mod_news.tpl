...
<div class="mod-news">
    ...
    <div class="mod-news-footer">
        ...
        <a href="{post_row.switch_link_readmore.U_READ_FULL}" rel="nofollow" class="rightside read-more"><i class="ion-ios-book-outline"></i><span>{post_row.switch_link_readmore.L_READ_FULL}</span></a>
