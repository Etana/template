                ...
                <dl>
                    ...
                    <dd>
                        <select name="currency" id="currency">
                            ...
                            <option value="{credit_card_method.switch_select_currency.select_currency.VALUE}" {credit_card_method.switch_select_currency.select_currency.SELECTED}>
                ...
                <dd>
                    <form action="{S_CREDITS_ADD_ACTION}" method="post" name="post">
                        <select id="{PAY_METHOD}_option" name="credits_option" style="width:250px">
                            ...
                            <option value="{credit_card_method.credits_option.VALUE}">
