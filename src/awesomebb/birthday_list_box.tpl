                ...
                <div class="inner"><span class="corners-top"><span></span></span>
                    <table class="table1" cellspacing="1">
                        ...
                        <tr class="{birthday_list_box.row.ROW_CLASS}">
                            <td><a class="topictitle" href="{birthday_list_box.row.U_VIEW_TOPIC}">{birthday_list_box.row.TOPIC_TITLE}</a>
                            </td>
                        ...
                        <!-- BEGIN no_topics -->
                        <tr>
                            <td class="row1" colspan="{birthday_list_box.row.COLSPAN}"><span class="gen">{birthday_list_box.row.L_NO_TOPICS}</span>
                            </td>
                        </tr>
                        <!-- END no_topics -->
