...
<form name="_calendar_scheduler" method="post" action="{ACTION}">
    <div class="topic-actions">
        <p><a href="{U_INDEX}">{L_INDEX}</a>{NAV_SEPARATOR}<a href="{U_CALENDAR_SCHEDULER}">{L_CALENDAR_SCHEDULER}</a>
        </p>
    </div>
    ...
    <div id="mini-calendar">
        ...
        <p style="text-align:center;"><a href="{U_CALENDAR}" title="{L_CALENDAR}" class="button">{L_CALENDAR}</a></p>
    </div>
