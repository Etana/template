...
<table class="forumline" width="100%" align="center" cellspacing="1" cellpadding="0">
	<tr>
		<th class="thTop" height="25"><span id="PicHeader">{PIC_TITLE}</span></th>
	</tr>
	<tr>
		<td class="row2" align="center">
		<form name="slideshow" action="{U_SLIDESHOW}" method="post" onsubmit="return true;"><span class="gensmall">{SLIDESHOW_SELECT}</span> <input type="submit" class="liteoption" value="{L_SLIDESHOW_ONOFF}" style="width: 150px" /><br />
		<br />
		<img src="{U_PIC}" id="SlideShowPic" border="0" alt="{PIC_TITLE}" title="{PIC_TITLE}" /></form>
		</td>
	</tr>
</table>