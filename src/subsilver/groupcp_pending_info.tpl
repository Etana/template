<table class="forumline" width="100%" border="0" cellspacing="1" cellpadding="4">
	...
	<tr>
		...
		<td class="{pending_members_row.ROW_CLASS}" align="center"><span class="gen"><a class="gen" href="{pending_members_row.U_VIEWPROFILE}">{pending_members_row.USERNAME}</a></span></td>
	...
	<tr>
		<td class="catBottom" colspan="8" align="right">
			<input class="mainoption" type="submit" name="approve" value="{L_APPROVE_SELECTED}" />
			&nbsp;&nbsp;
			<input class="liteoption" type="submit" name="deny" value="{L_DENY_SELECTED}" />
		</td>
	</tr>
</table>