    ...
    <table class="forumline" width="100%" border="0" cellspacing="1" cellpadding="4">
        ...
        <tr>
            ...
            <td class="row2" valign="top">
                ...
                <span class="genmed"><label for="rtags">{TAGS.L_SEARCH_TAGS}</label></span>
                <!-- END TAGS -->
            </td>
        </tr>
        <tr>
                        ...
                        <tr>
                            <th class="thHead" colspan="4" height="25">
                                ...
                                <div style="float: right; width: 2%">
                                    <a href="javascript:ShowHideLayernew('searchitems');"><img src="{TABS_LESS_IMG}" alt="-" align="middle" border="0" /></a>
                                </div>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <td class="row2">
                                <span class="genmed">
                                    <select class="post" name="search_where">
                                        {S_FORUM_OPTIONS}
                                    </select>
                                </span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="row2" valign="middle" nowrap="nowrap">
                                <span class="genmed">
                                    ...
                                    <label for="ASC">{L_SORT_ASCENDING}</label>
                                    <br />
                                    <input id="DESC" type="radio" name="sort_dir" value="DESC" checked="checked" />
                                    <label for="DESC">{L_SORT_DESCENDING}</label>
                                </span>&nbsp;
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="4">
                        <tr>
                            <th class="thHead" height="25">
                                ...
                                <div style="text-align: center; float: left; width: 95%">{L_SEARCH_OPTIONS}</div>
                                <div style="float: right; width: 2%">
                                    <a href="javascript:ShowHideLayernew('searchitems');"><img src="{TABS_MORE_IMG}" alt="+" align="middle" border="0" /></a>
                                </div>
                            </th>
                        </tr>
                    </table>
