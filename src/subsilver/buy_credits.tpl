...
<!-- BEGIN main_page -->
<table class="forumline" width="98%" border="0" cellspacing="1" cellpadding="5" align="center">
<tr>
	<th class="thHead" colspan="2">{L_CREDIT_ADD_TITLE}</th>
</tr>
<tr>
	<td class="row1">
		<br />
		<span class="gen">{TERMS_OF_SERVICE}</span>
		<div style="text-align:center;padding:40px 0 45px 0;">
			<span class="gen"><b>{L_MAKE_DONATION}</b></span>
		</div>
	</td>
</tr>
<tr>
			...
			<span class="gen">
				...
				<form action="{S_CREDITS_ADD_ACTION}" method="post" name="post" id="currency_form">
					...
					<div align="center">
						...
						<input type="submit" name="submitBtn" value="{L_SUBMIT}" />
					</div>
					<hr width="60%" />
				</form>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
				...
				<tr>
					<td width="50%" align="{RIGHT}" valign="bottom">
						<form action="{S_CONFIRM_ACTION}" method="post" target="_blank" accept-charset="UTF-8">
							<!-- BEGIN hidden_field -->
